...
<p>Para o segundo caso, $0<a<b$, seja $r=b-a$. Implica que $r>0$, pois $b>a$. Pela propriedade arquimediana, existe $n\in\N$ tal que $\frac{1}{n}<r$.</p>
...
<img src="/blog/assets/img/2024/05/07/propriedade_arquimediana_reais_em_intervalo.jpg" alt="Esquematização da propriedade arquimediana dos números reais em um intervalo aberto" style="width: 100%; max-width: 400px; margin-left: auto; margin-right: auto; display: block;">

<p>Logo, $\frac{m}{n}\in\Q\cap(a,\,b)$ para o segundo caso.</p>

<p>Para o \textbf{terceiro caso}, $a<b<0$, pode-se pensar no caso anterior refletido na origem:</p>

<img src="/blog/assets/img/2024/05/07/intervalo-refletido-origem.jpg" alt="Esquematização de um intervalo refletido na origem" style="width: 100%; max-width: 400px; margin-left: auto; margin-right: auto; display: block;">
